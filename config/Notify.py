...
class System(YamlObj):
    ...
    def __init__(self, execution_mode: str, fram_schd: str, run_id: str):
        self.execution_mode = execution_mode  # "ml" | "hpc"
        self.fram_schd = fram_schd            # framework (ML) or scheduler (HPC)
        self.run_id = run_id                  # ID for this run
        self.validate()
